...
public class ComparisonOperator {
	...
	public static void main(String[] args) {
		...
		b = 10.1f == 10.1;
		System.out.println(b); //실수의경우 값의 근사치를 표현

		System.out.printf("%22.20f%n",10.1f); //float 은 7자리까지 , double은 15자리까지 정확한값을 가지고있다.
		System.out.printf("%22.20f%n",10.1);
		 
		//double을 float으로 형변환 하면 정확하게 비교 할 수 있다.
		b = 10.1f ==(float)10.1;
		System.out.println(b);
